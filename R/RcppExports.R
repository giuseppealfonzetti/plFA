...
plSA <- function(FREQ, VALFREQ, N, C_VEC, CONSTRMAT, CONSTRLOGSD, THETA_INIT, NTHR, NLOAD, NCORR, NVAR, SAMPLER, PAIRS_PER_ITERATION, STEP_SCHEDULE, STEP0, STEP1, STEP2, STEP3, BURN, MAXT, TOLCOUNT, TOL, CHECKCONV, EACHCHECK, EACHPATH, EACHCLOCK, SEED, VERBOSE) {
    .Call(`_plFA_plSA`, FREQ, VALFREQ, N, C_VEC, CONSTRMAT, CONSTRLOGSD, THETA_INIT, NTHR, NLOAD, NCORR, NVAR, SAMPLER, PAIRS_PER_ITERATION, STEP_SCHEDULE, STEP0, STEP1, STEP2, STEP3, BURN, MAXT, TOLCOUNT, TOL, CHECKCONV, EACHCHECK, EACHPATH, EACHCLOCK, SEED, VERBOSE)
}

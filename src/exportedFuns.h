...
//   return Eigen::VectorXd::Zero(2);//params::get_thresholds_theta2vec(THETA, P, C);
// }
// //' @export
// // [[Rcpp::export]]
...
//                                          Eigen::Map<Eigen::MatrixXd> CONSTRMAT,
//                                          const int  NLOAD){
//   return Eigen::VectorXd::Zero(2);//params::get_loadings_mat2vec(LOADINGS, CONSTRMAT, NLOAD);
// }
//
// //' @export
// // [[Rcpp::export]]
...
//                                          Eigen::Map<Eigen::MatrixXd> CONSTRMAT){
//   return Eigen::MatrixXd::Zero(2,2);//params::get_loadings_vec2mat(LOADINGS, CONSTRMAT);
// }
//
// //' @export
// // [[Rcpp::export]]
// Eigen::VectorXd cpp_get_latvar_mat2vec(Eigen::Map<Eigen::MatrixXd> S){
//   return Eigen::VectorXd::Zero(2);//params::get_latvar_mat2vec(S);
// }
//
// //' @export
// // [[Rcpp::export]]
...
//                                        const int Q){
//   return Eigen::MatrixXd::Zero(2,2);//params::get_latvar_vec2mat(SVEC, Q);
// }
//
// //' @export
// // [[Rcpp::export]]
...
//     const int NLOAD
// ){
//   return Eigen::MatrixXd::Zero(2,2);//params::get_loadings_theta2mat(THETA, CONSTRMAT, P, C, NLOAD);
// }
//
// //' @export
// // [[Rcpp::export]]
...
//                                          const int CORRFLAG
// ){
//   return Eigen::MatrixXd::Zero(2,2);//params::get_latvar_theta2mat(THETA, Q, D, CORRFLAG);
// }
//
// //' @export
// // [[Rcpp::export]]
...
//                                          const int NCORR,
//                                          const int CORRFLAG){
//   return Eigen::VectorXd::Zero(2);// params::get_latvar_theta2vec(THETA, NTHR, NLOAD, NCORR, CORRFLAG);
// }

...
set.seed(123)
  ...
  llc <- NULL
  A <- plFA:::check_cnstr_loadings(A, stdlv, LLC=llc)
  ...
  R <- plFA:::cpp_latvar_vec2cmat(VEC=tcorrvec, NCORR=ncorr, Q=q)


  # Generate random latent variances
  constr_var <- rep(NA, q)
  constr_lsd <- plFA:::check_cnstr_latvar(constr_var, q, stdlv)

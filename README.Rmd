...
Let's rerun the above example, but this time using the stochastic approximation algorithm and the original 6-point scale data.
...
All^[Most :)] `lavaan` methods should carry over, such as:
